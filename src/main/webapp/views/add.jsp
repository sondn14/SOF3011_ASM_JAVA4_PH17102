	...
	<div class="container-fluid">
		...
		<div class="container">
			<div class="row">
				...
				<form action="/cuahangxemay/motobike/add" method="POST">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Kiểu xe</label> <select
							name="id-type" class="form-control me-2">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Màu xe</label> <select
							name="id-color" class="form-control me-2">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Hãng xe</label> <select
							name="id-company" class="form-control me-2">
							<c:forEach var="motobikeCompany" items="${motobikeCompany}">
								<option value="${motobikeCompany.companyId}"<c:if test="${motobikeCompany.companyName == motobike.motobikeCompany.companyName}"> selected ="selected" </c:if>>${motobikeCompany.companyName}</option>
							</c:forEach>
						</select>
					</div>
					<div class="form-group">
